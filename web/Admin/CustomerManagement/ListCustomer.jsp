            ...
            <div class="sm:flex sm:items-center">
                ...
                <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                    <button type="button" class="block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                        <a href="/ResortHub/Admin/CustomerManagement/CreateCustomer.jsp"> Add Customer</a>
                    </button>
                </div>
            </div>
                                    ...
                                    <c:forEach items="${customers}" var="c">
                                        ...
                                        <tr class="hover:bg-gray-200 ">
                                            ...
                                            <td class="relative whitespace-nowrap py-4 pl-3 text-right text-sm font-medium sm:pr-6">
                                                <a href="/ResortHub/CustomerController?action=getById&id=${c.id}" class="text-indigo-600 hover:text-indigo-900 cursor-pointer">
                                            ...
                                            <td class="relative whitespace-nowrap py-4 pr-4 text-right text-sm font-medium sm:pr-6">
                                                <a href="/ResortHub/CustomerController?action=delete&id=${c.id}" class="text-red-600 hover:text-red-900 cursor-pointer">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <nav class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mt-6">
                            <div class="-mt-px flex w-0 flex-1">
                                <c:if test="${meta.page > 1}">
                                    <a href='CustomerController?action=getAll&Page=${meta.page - 1}&PageSize=10' class="inline-flex items-center border-t-2 border-transparent pr-1 pt-4 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">
                            ...
                            <div class="hidden md:-mt-px md:flex">
                                <c:forEach begin="1" end="${meta.pageCount}" varStatus="page">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <a href='CustomerController?action=getAll&Page=${page.index}&PageSize=10' class="inline-flex items-center border-t-2 border-transparent px-4 pt-4 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">${page.index}</a>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                            </div>
                            ...
                            <div class="-mt-px flex w-0 flex-1 justify-end">
                                <c:if test="${meta.page < meta.pageSize && meta.page < meta.pageCount}">
                                    <a href='CustomerController?action=getAll&Page=${meta.page + 1}&PageSize=10' class="inline-flex items-center border-t-2 border-transparent pl-1 pt-4 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">
                                        Next
