...
<html>
    ...
    <body >
        ...
        <div class="bg-white">
            <div class="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
                <div class="relative isolate overflow-hidden bg-gray-900 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
                    <h2 class="mx-auto max-w-2xl text-3xl font-bold tracking-tight text-white sm:text-4xl">Enjoy the world today.</h2>
        ...
        <jsp:include page="/pages/Home/Story.jsp"/>
        <jsp:include page="/pages/Home/Partner.jsp"/>
         <jsp:include page="/pages/Home/FAQs.jsp"/>
