...
public class CreateCustomerDto {
    ...
    public CreateCustomerDto(HttpServletRequest request) {
        ...
        customerType = CustomerType.fromIndex(ConvertUtils.convertStringToInt(request.getParameter("CustomerType")));
